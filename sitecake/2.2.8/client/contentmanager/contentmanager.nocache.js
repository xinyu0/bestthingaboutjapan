function contentmanager(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_42, $intern_56], $intern_57);
      unflattenKeylistIntoAnswers([$intern_47, $intern_56], $intern_58);
      unflattenKeylistIntoAnswers([$intern_47, $intern_51], $intern_58);
      unflattenKeylistIntoAnswers([$intern_47, $intern_56], $intern_58 + $intern_59);
      unflattenKeylistIntoAnswers([$intern_47, $intern_51], $intern_58 + $intern_59);
      unflattenKeylistIntoAnswers([$intern_44, $intern_56], $intern_60);
      unflattenKeylistIntoAnswers([$intern_44, $intern_51], $intern_60);
      unflattenKeylistIntoAnswers([$intern_44, $intern_56], $intern_60 + $intern_59);
      unflattenKeylistIntoAnswers([$intern_44, $intern_51], $intern_60 + $intern_59);
